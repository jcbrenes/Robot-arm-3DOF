...
bool BlackI2C::loadDeviceTree() { return false; }
...
std::string BlackI2C::getPortName() { return this->i2cPortPath; }

bool BlackI2C::isOpen() { return this->isOpenFlag; }

bool BlackI2C::isClose() { return !(this->isOpenFlag); }
...
void BlackI2C::printInfo() {

	std::cout << "Port Path: " <<	this->i2cPortPath
			<< ", Device Access: 0x" << std::hex << (int) this->i2cDevAddress
			<< ", File Descriptor: " <<  this->i2cFD
